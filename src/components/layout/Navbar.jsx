    ...
    >
        ...
        <div className="md:hidden">
          <motion.button
            ...
            className={`p-2 rounded-lg border-2 transition-colors duration-300
                      ${isDarkMode 
                        ? 'border-solarized-base01 text-solarized-base1 hover:border-solarized-base1' 
                        : 'border-solarized-base1 text-solarized-base01 hover:border-solarized-base01'}`}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            {navbarOpen ? (
      ...
      {navbarOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className={`md:hidden ${
            isDarkMode ? 'bg-solarized-base03Deep/95' : 'bg-solarized-base2/95'
          }`}
        >
              ...
              {navLinks.map((link, index) => (
                <div 
                  ...
                  className={`text-center py-1.5 hover:bg-opacity-10 hover:bg-white w-full
                    ${isDarkMode 
                      ? 'hover:text-solarized-base3' 
                      : 'hover:text-solarized-base03'}`}
